            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-transparent border-b-2 border-[#DDCBAE] focus:border-[#A6472F] outline-none py-2 pr-12 text-[#241F1C] placeholder:text-[#B8AA90] transition-colors"
                />
                <button
                  type="button"
