  ...
  return (
    ...
    >
      <div className="w-full max-w-sm">
        {/* Signature: dokan-er awning stripe */}
        <div
        ...
        <div
          className="bg-[#FBF6EC] rounded-b-2xl shadow-xl px-8 pt-7 pb-8 border border-[#E3D2B4] border-t-0"
        >
          ...
          <p className="text-sm text-[#6B6055] mb-7">
            Start selling online in a few minutes.
          </p>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            >
              {loading ? 'Opening shop…' : 'Create account'}
            </button>
          </form>

          <p className="text-xs text-[#8A7C63] text-center mt-6">
            Already have a shop?{' '}
            <a href="/login" className="text-[#A6472F] font-medium hover:underline">
              Log in
            </a>
          </p>
        </div>
