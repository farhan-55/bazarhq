    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F7EFE0] px-4">
        <div className="bg-[#FBF6EC] rounded-2xl shadow-xl border border-[#E3D2B4] px-8 py-8 max-w-sm text-center">
          <p className="text-[#A6472F]">{error}</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-[#F7EFE0] px-6 py-10">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-[26px] font-semibold text-[#241F1C] mb-6">Shop settings</h1>
        ...
        <div className="bg-[#FBF6EC] rounded-2xl shadow-md border border-[#E3D2B4] px-6 py-5">
